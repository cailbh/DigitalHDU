  ...
  Animate:(controls,scene,camera,renderer,composer,finalComposer)=>{
    ...
    function darkenNonBloomed( obj ) {
      ...
      if ( obj.isMesh && bloomLayer.test( obj.layers ) === false ) {
        ...
        console.log(objName)
        if((filenames['Teaching'].indexOf(objName[objName.length-1])<0)&&((filenames['Living'].indexOf(objName[objName.length-1])<0))&&(objName[objName.length-1]!="Teaching_Ground")){
