      ...
      if (intersects.length) {
        ...
        // intersects[0].object.add(new THREE.LineSegments(intersects[0].object.geometry, lineMaterial));
          ...
          let shaderMaterial = new THREE.ShaderMaterial({
              ...
              let boundingBox = box.geometry.boundingBox;
          ...
          create.createBox(scene,(box.max.x - box.min.x),(box.max.y - box.min.y),(box.max.z - box.min.z),worldPosition.x,worldPosition.y,worldPosition.z);
