...
export default {
  ...
  methods: {
    ...
    outlineObj (selectedObjects) {
      ...
      effectFXAA.material.uniforms[ 'resolution' ].value.x = 1 / (domData.offsetWidth * pixelRatio)
      effectFXAA.material.uniforms[ 'resolution' ].value.y = 1 / (domData.offsetHeight * pixelRatio)
