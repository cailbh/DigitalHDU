...
export default {
  ...
  create.createBuildingGLTF('Teaching_Ground',0,0,0);
  create.createBuildingIFC('Teaching_library',0,0,0);
  create.createBuildingIFC('生活区单独模型/2号楼',0,0,-1000);
  create.createBuildingIFC('生活区单独模型/3号楼',0,0,-1000);
  create.createBuildingIFC('生活区单独模型/4号楼北',0,0,-1000);
  create.createBuildingIFC('生活区单独模型/4号楼南',0,0,-1000);
  ...
  // create.createScene()
  create.createBox(1000,0,1000,0,0,-1000)
  create.createAmbientLinght()
  create.createDirectionalLight(1000,2000,1000)
