...
export default {
  ...
  //添加物体
  // scene.add(create.createBuildings('Living01',0,0,0);
  // scene.add(create.createBuildings('Living02',0,0,0);
  // for(var i=0;i<30;i++){
    
  // scene.add(create.createBuildings('Teaching02',i*30,0,i*30);
  // }
  // scene.add(create.createBuildings('Teaching02',0,0,0);
  scene.add(create.createBuildingGLTF('Teaching_Ground',0,0,0));
  scene.add(create.createBuildingIFC('Teaching_library',0,0,0));
  scene.add(create.createBuildingIFC('生活区单独模型/2号楼',0,0,-1000));
  scene.add(create.createBuildingIFC('生活区单独模型/3号楼',0,0,-1000));
  scene.add(create.createBuildingIFC('生活区单独模型/4号楼北',0,0,-1000));
  scene.add(create.createBuildingIFC('生活区单独模型/4号楼南',0,0,-1000));
  // scene.add(create.createBuildingIFC('教学区单独模型/笃学楼（10教）',0,0,0));
  // scene.add(create.createBuildingIFC('教学区单独模型/科技馆和国际教育中心',0,0,0));
  // scene.add(create.createBuildingIFC('教学区单独模型/力行楼（9教）',0,0,0));
  // scene.add(create.createBuildingOBJ('Teaching_library',0,0,0));
  // scene.add(create.createBuildingGLTF('Teaching_library',0,0,0));
  // scene.add(create.createBuildings('楼001',0,0,0));
  // scene.add(create.createBuilding('building3',100,0,300));
  // scene.add(create.createBuilding('building4',150,0,150));
  // scene.add(create.createBuilding('building5',200,0,20));
  // scene.add(create.createBuilding('building6',250,0,120));
  // scene.add(create.createBuilding('building7',300,0,20));
  // scene.add(create.createScene()
  scene.add(create.createBox(1000,0,1000,0,0,-1000));
  scene.add(create.createAmbientLinght());
  scene.add(create.createDirectionalLight(1000,2000,1000));
  // scene.add(create.createPointLinght(500,800,500,10000,2)
  // changeSky("night")
  },
  mounted() {
