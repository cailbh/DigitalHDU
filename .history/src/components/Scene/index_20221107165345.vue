...
export default {
  ...
  created() {
    ...
    create.createBuildingGLTF(scene,'Teaching_Ground',0,0,0);
    create.createBuildingIFC(scene,'Teaching_library',0,0,0);
    create.createBuildingIFC(scene,'生活区单独模型/2号楼',0,0,-1000);
    create.createBuildingIFC(scene,'生活区单独模型/3号楼',0,0,-1000);
    create.createBuildingIFC(scene,'生活区单独模型/4号楼北',0,0,-1000);
    create.createBuildingIFC(scene,'生活区单独模型/4号楼南',0,0,-1000);
  ...
  // create.createScene()
    create.createBox(scene,1000,0,1000,0,0,-1000)
    create.createAmbientLinght(scene)
    create.createDirectionalLight(scene,1000,2000,1000)
    // create.createPointLinght(500,800,500,10000,2)
    // changeSky("night")
    create.animate(controls,scene,camera,renderer)
    _this.scene = create.Scene()
    _this.camera = create.PerspectiveCamera()
    _this.renderer = create.Rendererr()
    _this.controls = create.Controls(camera,renderer)
  },
  mounted() {
    this.$refs.sceneDiv.appendChild(_this.renderer.domElement)
