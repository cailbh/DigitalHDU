  ...
  methods: {
    ...
    onmodelMousemove(event){
      ...
      if (intersects.length) {
        ...
        if(filenames['Teaching'].indexOf(objName[objName.length-1])){
          console.log(filenames['Teaching'],filenames['Teaching'].indexOf(objName[objName.length-1]),objName[objName.length-1])
