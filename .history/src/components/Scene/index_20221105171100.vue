          ...
          worldPosition.z +=(box.max.z - box.min.z)/2
            ...
            .then((dataUrl) => {
              ...
              scene.add(sprite);
                        ...
                        console.log(sprite)
                        sprite.position.set(worldPosition.x, worldPosition.y + 3+document.getElementById("teachersContain").clientHeight, worldPosition.z); // 根据刚才获取的世界坐标设置精灵模型位置，高度加了3，是为了使精灵模型显示在点击模型的上方
