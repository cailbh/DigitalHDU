...
export default {
		...
		methods: {
			...
			getdata(){
					...
					this.data = [
							{ inValue: 445, name: '6月' ,outValue: 600},
							{ inValue: 675, name: '7月',outValue: 700 },
							{ inValue: 536, name: '8月' ,outValue: 800},
							{ inValue: 389, name: '9月',outValue: 400 },
							{ inValue: 160, name: '10月',outValue: 300 },
							{ inValue: 160, name: '11月',outValue: 300 },
							// { inValue: 60, name: '6月' },
						]
