<template>
  <div id="root">
    ...
    <div id="Container">
      ...
      <div id="left">
        <div id="leftup" class="panel">
          <polarStacked></polarStacked>
        </div>
        <div id="leftdown" class="panel">
          <bar></bar>
        </div>
      </div>
      ...
      <div id="right">     
        <div id="rightup" class="panel">
         <lineChart></lineChart>
        </div>
        <div id="rightdown" class="panel">
          <radar></radar>
        </div>
      </div>
    </div>
...
import polarStacked from "../../components/PolarStacked/index.vue";
export default {
  components: { scene,bar,polarStacked,radar,lineChart,Head},
  // components: { button1 },
