    ...
    <div id="Container">
      ...
      <div id="head">
        ...
        <transition name="homeLeftTran">
          <homeLeft v-show="showLeft" ></homeLeft>
        </transition>
        ...
        <transition name="homeRightTran">
          <homeRight v-show="showRight"></homeRight>
        </transition>
        <transition name="homeBottomTran">
          <homeBottom v-show="showBottom"></homeBottom>
        </transition>
    </div>
  </div>
</template>
...
export default {
  ...
  watch: {
    ...
    showScene(val){
      if(val==false){
        console.log('fa')
        this.timer = setTimeout(this.changeSceneShow(), 1000);
      }
    },
    barType(val){
      if("Living"==val){
